function [normal_out noncompute] = compute_normal_jjcao_EACH1(points , can_nei , orientation , area_w , mp)
...
%     points_temp(1 , :) = [];
    ...
    [V2,D2] = eig(C2);  % 15s
    fix_normal2 = V2(:,1);
    cur_plane2 = D2(1,1)/(D2(1,1) + D2(2,2) + D2(3,3)) % 15s
